...
const data: MindmapNode = {
  name: "What topics are covered in Chapter 13: Data Types & Structures?",
  id: "ch13-root",
  children: [
    {
...
- Implement and justify the use of stacks, queues, and linked lists`
    ...
    {
      name: "Which primitive data types are built into most languages?",
      id: "primitive-data-types",
      summary: `INTEGER, REAL, CHAR, STRING, BOOLEAN, DATE. Atomic types built-in to languages.`
    },
    {
      name: "What additional data types are discussed beyond the primitives?",
...
DATE (day/month/year; supports date arithmetic).`
    ...
    {
      name: "What are record structures and how are they used?",
    ...
    {
      name: "How are arrays declared and processed?",
      id: "arrays",
      children: [
        {
          name: "How do you declare and use one-dimensional arrays?",
          id: "one-dimensional-arrays",
          summary: `Declare as ARRAY[lower:upper] OF type; single-indexed list.`
        },
        {
          name: "How do you declare and use two-dimensional arrays?",
          id: "two-dimensional-arrays",
          summary: `Declare as ARRAY[rowLB:rowUB][colLB:colUB] OF type; matrix.`
        },
        {
          name: "How do you sort and search within arrays?",
          id: "array-processing",
    ...
    },
    {
      ...
      children: [
        ...
        {
          name: "What is a linked list ADT and how does it work?",
          id: "linked-list",
