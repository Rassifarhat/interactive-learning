...
const data: MindmapNode = {
  name: "What are the learning objectives of Chapter 15: Software Development?",
  id: "ch15-root",
  children: [
    {
      name: "What are the main stages of the software development life cycle and what does each stage involve?",
      id: "dev-life-cycle",
      children: [
        {
          name: "What activities are carried out during the Analysis stage?",
          id: "lifecycle-analysis",
          summary: "Investigate issues, define requirements specification."
        },
        {
          name: "How is the solution planned in the Design stage?",
          id: "lifecycle-design",
          summary: "Plan solution via flowcharts/pseudocode and data structures."
        },
        {
          name: "What happens during the Coding (Implementation) stage?",
          id: "lifecycle-coding",
          summary: "Convert pseudocode to code; compile and debug."
        },
        {
          name: "Which testing practices are applied in the Testing stage?",
          id: "lifecycle-testing",
          summary: "Conduct thorough testing under varied conditions."
        },
        {
          name: "What is involved in the Maintenance stage of the cycle?",
          id: "lifecycle-maintenance",
          summary: "Perform fixes and enhancements until cycle restarts."
        }
      ]
    },
    {
      name: "How do the Waterfall, Iterative, and RAD development methodologies differ?",
      id: "dev-methodologies",
      children: [
        {
          name: "What defines the Waterfall Model, and what are its advantages and disadvantages?",
          id: "waterfall-model",
          summary: "Sequential fixed stages; benefits: simplicity, management; drawbacks: inflexibility, late feedback."
        },
        {
          name: "How does the Iterative Model work, and what pros and cons does it present?",
          id: "iterative-model",
          summary: "Incremental development; benefits: early feedback, risk reduction; drawbacks: more planning, resources."
        },
        {
          name: "What is the RAD Model, and what are its strengths and weaknesses?",
          id: "rad-model",
          summary: "Prototype-driven cycles; benefits: rapid delivery, user feedback; drawbacks: skilled team needed."
        }
      ]
    },
    {
      name: "What purpose do structure charts serve and how are they used?",
      id: "structure-charts",
      children: [
        {
          name: "Why use structure charts for module decomposition?",
          id: "structure-purpose",
          summary: "Visual module decomposition showing hierarchy and relationships."
        },
        {
          name: "How are parameters represented in structure charts?",
          id: "structure-parameters",
          summary: "Arrows indicate data flow (interface) between modules."
        },
        {
          name: "How can you derive pseudocode from a structure chart?",
          id: "structure-pseudocode",
          summary: "Convert structure charts into pseudocode steps."
        }
      ]
    },
    {
      name: "How do state-transition diagrams model algorithm behavior?",
      id: "state-transition-diagrams",
      children: [
        {
          name: "What is the purpose of a state-transition diagram?",
          id: "std-purpose",
          summary: "Model algorithm states and transitions graphically."
        },
        {
          name: "Can you give an example of a state-transition diagram?",
          id: "std-example",
          summary: "Finite State Machine illustrating two's complement operation."
        }
      ]
    },
    {
      name: "What types of errors occur in software, and how are they debugged?",
      id: "error-types-debugging",
      children: [
        {
          name: "What are the differences between syntax, logic, and run-time errors?",
          id: "error-types",
          summary: "Syntax, logic, and run-time errors."
        },
        {
          name: "Which techniques help locate and correct software faults?",
          id: "debugging",
          summary: "Techniques to locate, identify, and correct faults."
        }
      ]
    },
    {
      name: "Which testing methods are used and how do you choose test data?",
      id: "testing-methods",
      children: [
        {
          name: "What are the main testing methods from dry‑run to acceptance testing?",
          id: "testing-methods-list",
          summary: "Dry-run, walkthrough, white-box, black-box, integration, alpha, beta, acceptance, stub testing."
        },
        {
          name: "How do you create a test strategy and select normal, abnormal, and boundary data?",
          id: "testing-planning",
          summary: "Create test strategy/plan and select normal, abnormal, boundary data."
        }
      ]
    },
    {
      name: "What are the types of maintenance and when are they applied?",
      id: "maintenance",
      children: [
        {
          name: "What is corrective maintenance and when is it needed?",
          id: "maintenance-corrective",
          summary: "Fix bugs and errors."
        },
        {
          name: "What does adaptive maintenance involve?",
          id: "maintenance-adaptive",
          summary: "Adapt program for new requirements or platforms."
        },
        {
          name: "How does perfective maintenance improve software?",
          id: "maintenance-perfective",
          summary: "Optimize and enhance performance and maintainability."
        }
      ]
    }
  ]
