...
const CsCh15MindMap: React.FC = () => {
  ...
  // Mind map data for Chapter 15
  const data: MindmapNode = {
    name: "Chapter 15: Software Development",
    id: "ch15-root",
    children: [
      {
...
- Describe and compare different life cycles (waterfall, iterative, RAD)
- Understand analysis, design, coding, testing, maintenance
- Use and construct structure charts
- Use state-transition diagrams
- Identify and correct errors (syntax, logic, run-time)
- Understand testing methods (dry-run, walkthrough, white/black-box, integration, alpha, beta, acceptance, stub)
- Select and justify test data
- Understand test strategy, test plan, and maintenance types (corrective, adaptive, perfective)
- Analyse and enhance programs.`,
      },
      {
        name: "Development Life Cycle Stages",
        id: "dev-life-cycle",
        children: [
          { name: "Analysis", id: "lifecycle-analysis", summary: `Investigate issues, define requirements specification.` },
          { name: "Design", id: "lifecycle-design", summary: `Plan solution via flowcharts/pseudocode and data structures.` },
          { name: "Coding (Implementation)", id: "lifecycle-coding", summary: `Convert pseudocode to code; compile and debug.` },
          { name: "Testing", id: "lifecycle-testing", summary: `Conduct thorough testing under varied conditions.` },
          { name: "Maintenance", id: "lifecycle-maintenance", summary: `Perform fixes and enhancements until cycle restarts.` }
        ]
      },
      {
        ...
        children: [
          { name: "Waterfall Model", id: "waterfall-model", summary: `Sequential fixed stages; benefits: simplicity, management; drawbacks: inflexibility, late feedback.` },
          { name: "Iterative Model", id: "iterative-model", summary: `Incremental development; benefits: early feedback, risk reduction; drawbacks: more planning, resources.` },
          { name: "RAD Model", id: "rad-model", summary: `Prototype-driven cycles; benefits: rapid delivery, user feedback; drawbacks: skilled team needed.` }
        ]
      },
      {
        ...
        id: "structure-charts",
        children: [
          { name: "Purpose", id: "structure-purpose", summary: `Visual module decomposition showing hierarchy and relationships.` },
          { name: "Parameters", id: "structure-parameters", summary: `Arrows indicate data flow (interface) between modules.` },
          { name: "Pseudocode Derivation", id: "structure-pseudocode", summary: `Convert structure charts into pseudocode steps.` }
        ]
      },
      {
        ...
        children: [
          { name: "Purpose", id: "std-purpose", summary: `Model algorithm states and transitions graphically.` },
          { name: "Example", id: "std-example", summary: `Finite State Machine illustrating two's complement operation.` }
        ]
      },
      {
        ...
        children: [
          { name: "Error Types", id: "error-types", summary: `Syntax, logic, and run-time errors.` },
          { name: "Debugging", id: "debugging", summary: `Techniques to locate, identify, and correct faults.` }
        ]
      },
      {
        name: "Testing Methods & Test Data",
        id: "testing-methods",
        children: [
          { name: "Methods", id: "testing-methods-list", summary: `Dry-run, walkthrough, white-box, black-box, integration, alpha, beta, acceptance, stub testing.` },
          { name: "Planning & Data", id: "testing-planning", summary: `Create test strategy/plan and select normal, abnormal, boundary data.` }
        ]
      },
      {
        name: "Maintenance",
        id: "maintenance",
        children: [
          { name: "Corrective", id: "maintenance-corrective", summary: `Fix bugs and errors.` },
          { name: "Adaptive", id: "maintenance-adaptive", summary: `Adapt program for new requirements or platforms.` },
          { name: "Perfective", id: "maintenance-perfective", summary: `Optimize and enhance performance and maintainability.` }
        ]
      }
    ]
  };
  ...
  useEffect(() => {
    ...
    node.append("circle")
      ...
      .attr("r", d => d.data.id === "ch15-root" ? 10 : 6)
      ...
      .on("mouseover", (event: MouseEvent, d: any) => {
        d3.select(event.currentTarget as SVGCircleElement)
          .attr('r', (d: any) => d.data.id === 'ch15-root' ? 12 : 8)
          .attr('stroke', 'black');
      })
      .on("mouseout", (event: MouseEvent, d: any) => {
        d3.select(event.currentTarget as SVGCircleElement)
          .attr('r', (d: any) => d.data.id === 'ch15-root' ? 10 : 6)
          .attr('stroke', null);
      });
    node.append("text")
      .attr("data-id", d => d.data.id)
    ...
    if (!activeNode) {
      setInfoContent("Click on any node to see detailed information about that topic from Chapter 15.");
    }
  ...
  return (
    <div className="flex flex-col w-full h-screen bg-gray-800 text-white">
      <div className="p-2 bg-gray-700 text-center sticky top-0 z-10">
        <h1 className="text-xl font-semibold">Chapter 15: Software Development</h1>
      </div>
          ...
          <div className="bg-gray-800 rounded-lg shadow p-4">
            ...
            <div className="prose prose-invert max-w-none text-gray-300 whitespace-pre-line mb-4">
              {infoContent ? (
                ...
                <p>Click on a node in the mindmap to see detailed information about that topic from Chapter 15.</p>
              )}
            </div>
            {saveStatus && (
