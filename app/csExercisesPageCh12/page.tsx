...
import { exercises } from '../data/csExercisesCh12';

export default function CSExercisesPage12() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <h2 className="text-3xl font-semibold mb-8 text-center text-yellow-300">
        Computer Science Chapter 12 Exercises
      </h2>
        ...
        {exercises.map((exercise) => (
          ...
          >
            <div className="p-5">
              ...
              <div className="mb-3">
                <Link 
                  href={`/playground?id=${exercise.id}&chapter=12`}
