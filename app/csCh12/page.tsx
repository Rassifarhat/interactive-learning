...
const CsCh12MindMap: React.FC = () => {
  ...
  // Mind map data for Chapter 12
  const data: MindmapNode = {
    name: "Chapter 12: Algorithm Design & Problem-solving",
    id: "ch12-root",
    children: [
      {
...
- Employ logic statements in algorithms`
      },
      {
        ...
        children: [
          { name: "Abstraction", id: "abstraction", summary: `Filter out unnecessary details; focus on essentials.` },
          { name: "Decomposition", id: "decomposition", summary: `Break problems into sub-tasks; leads to modules/procedures.` },
          { name: "Data Modelling", id: "data-modelling", summary: `Organise data via abstract types, classes, or data models.` },
          { name: "Pattern Recognition", id: "pattern-recognition", summary: `Identify common patterns; reuse standard algorithms.` },
          { name: "Algorithmic Thinking", id: "algorithmic-thinking", summary: `Develop step-by-step solution instructions.` }
        ]
      },
      { name: "What is an Algorithm?", id: "what-is-algorithm", summary: `A problem solution as a sequence of defined steps (e.g., recipes).` },
      {
        name: "Expressing Algorithms",
        id: "expressing-algorithms",
        children: [
          { name: "Structured English", id: "structured-english", summary: `Command statements subset of English.` },
          { name: "Pseudocode", id: "pseudocode", summary: `Language-like format without strict syntax.` },
          { name: "Flowchart", id: "flowchart", summary: `Graphical shapes linked to represent logic.` }
        ]
      },
      { name: "Variables", id: "variables", summary: `Named memory locations; use CamelCaps; identifiers hold values.` },
      { name: "Assignments", id: "assignments", summary: `Store or change values in variables (e.g., INPUT Number).` },
      {
        name: "Pseudocode & Constructs",
        id: "pseudocode-constructs",
        children: [
          { name: "Assignment", id: "assignment-construct", summary: `Give or change a value for an identifier.` },
          { name: "Sequence", id: "sequence-construct", summary: `Execute steps in order.` },
          { name: "Selection", id: "selection-construct", summary: `Conditional execution (IF/THEN/ELSE).` },
          { name: "Repetition", id: "repetition-construct", summary: `Loop constructs (REPEAT, FOR, rogue value).` }
        ]
      },
      { name: "Loops", id: "loops", summary: `Use loops to avoid redundant code: REPEAT…UNTIL, FOR…NEXT, rogue value.` },
      { name: "Stepwise Refinement", id: "stepwise-refinement", summary: `Refine outline into smaller, programmable steps.` },
      { name: "Modules", id: "modules", summary: `Procedures/functions to group and call sub-tasks.` }
    ]
  };
  ...
  useEffect(() => {
    ...
    node.append("circle")
      ...
      .attr("r", d => d.data.id === "ch12-root" ? 10 : 6)
      ...
      .on("mouseover", (event: MouseEvent, d: any) => {
        d3.select(event.currentTarget as SVGCircleElement)
          .attr('r', (d: any) => d.data.id === 'ch12-root' ? 12 : 8)
          .attr('stroke', 'black');
      })
      .on("mouseout", (event: MouseEvent, d: any) => {
        d3.select(event.currentTarget as SVGCircleElement)
          .attr('r', (d: any) => d.data.id === 'ch12-root' ? 10 : 6)
          .attr('stroke', null);
      });
    node.append("text")
      .attr("data-id", d => d.data.id)
    ...
    if (!activeNode) {
      setInfoContent("Click on any node to see detailed information about that topic from Chapter 12.");
    }
  ...
  return (
    <div className="flex flex-col w-full h-screen bg-gray-800 text-white">
      <div className="p-2 bg-gray-700 text-center sticky top-0 z-10">
        <h1 className="text-xl font-semibold">Chapter 12: Algorithm Design & Problem-solving</h1>
      </div>
          ...
          <div className="bg-gray-800 rounded-lg shadow p-4">
            ...
            <div className="prose prose-invert max-w-none text-gray-300 whitespace-pre-line mb-4">
              {infoContent ? (
                ...
                <p>Click on a node in the mindmap to see detailed information about that topic from Chapter 12.</p>
              )}
            </div>
            {saveStatus && (
