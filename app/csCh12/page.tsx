...
const data: MindmapNode = {
  name: "What topics are covered in Chapter 12: Algorithm Design & Problem‑solving?",
  id: "ch12-root",
  children: [
    {
      name: "What skills and understanding should you have by the end of this chapter?",
      id: "learning-objectives",
      summary: `By the end of this chapter you should be able to:
- Understand abstraction
- Create abstract models
- Use decomposition to break down problems
- Describe algorithms as step sequences
- Choose identifiers and document using pseudocode
- Apply assignment, sequence, selection, repetition constructs
- Use stepwise refinement
- Employ logic statements in algorithms`
    },
    {
      name: "What are the key components of computational thinking?",
      id: "computational-thinking",
      children: [
        {
          name: "What is abstraction and why is it important?",
          id: "abstraction",
          summary: `Filter out unnecessary details; focus on essentials.`
        },
        {
          name: "How does decomposition help solve complex problems?",
          id: "decomposition",
          summary: `Break problems into sub-tasks; leads to modules/procedures.`
        },
        {
          name: "What is data modelling in computational thinking?",
          id: "data-modelling",
          summary: `Organise data via abstract types, classes, or data models.`
        },
        {
          name: "How does pattern recognition improve algorithm design?",
          id: "pattern-recognition",
          summary: `Identify common patterns; reuse standard algorithms.`
        },
        {
          name: "What does algorithmic thinking involve?",
          id: "algorithmic-thinking",
          summary: `Develop step-by-step solution instructions.`
        }
      ]
    },
    {
      name: "How is an algorithm defined?",
      id: "what-is-algorithm",
      summary: `A problem solution as a sequence of defined steps (e.g., recipes).`
    },
    {
      name: "In what ways can algorithms be expressed?",
      id: "expressing-algorithms",
      children: [
        {
          name: "What is structured English and how is it used?",
          id: "structured-english",
          summary: `Command statements subset of English.`
        },
        {
          name: "What is pseudocode and why use it?",
          id: "pseudocode",
          summary: `Language-like format without strict syntax.`
        },
        {
          name: "How do flowcharts represent algorithm logic?",
          id: "flowchart",
          summary: `Graphical shapes linked to represent logic.`
        }
      ]
    },
    {
      name: "What are variables in algorithm design?",
      id: "variables",
      summary: `Named memory locations; use CamelCaps; identifiers hold values.`
    },
    {
      name: "What is an assignment in algorithms?",
      id: "assignments",
      summary: `Store or change values in variables (e.g., INPUT Number).`
    },
    {
      name: "What pseudocode constructs should you know?",
      id: "pseudocode-constructs",
      children: [
        {
          name: "How is the assignment construct used in pseudocode?",
          id: "assignment-construct",
          summary: `Give or change a value for an identifier.`
        },
        {
          name: "What does the sequence construct do?",
          id: "sequence-construct",
          summary: `Execute steps in order.`
        },
        {
          name: "How does the selection construct work?",
          id: "selection-construct",
          summary: `Conditional execution (IF/THEN/ELSE).`
        },
        {
          name: "What is the repetition construct in pseudocode?",
          id: "repetition-construct",
          summary: `Loop constructs (REPEAT, FOR, rogue value).`
        }
      ]
    },
    {
      name: "How are loops used to avoid redundant code?",
      id: "loops",
      summary: `Use loops to avoid redundant code: REPEAT…UNTIL, FOR…NEXT, rogue value.`
    },
    {
      name: "What is stepwise refinement in algorithm development?",
      id: "stepwise-refinement",
      summary: `Refine outline into smaller, programmable steps.`
    },
    {
      name: "How do modules support problem‑solving in algorithms?",
      id: "modules",
      summary: `Procedures/functions to group and call sub-tasks.`
    }
  ]
};
